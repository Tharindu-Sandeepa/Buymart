...
<div class="header">	 
	<div class="navbar">
		<a href="dashboard.php" >Dashboard</a>
			...
			<a href="admindata.php" class="active">Admin Accounts</a>
...
<div class="usertable">
	...
	<table border="1" class="table1">
		...
		$sql = "SELECT name,email,password,admin_id FROM admin";
		...
		if ($result->num_rows > 0) {
			while ($row = $result->fetch_assoc()) {
				echo "<tr>
						...
						<td>
						<div class='buttons'>
							<form method='post' action='removead.php'>
								<input type='hidden' name='name' value='".$row["admin_id"]."'>
